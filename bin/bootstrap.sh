...
# Ensure app folder exists and images are built
mkdir -p app
docker compose build

# Run a one-off container to scaffold the project (if manage.py missing)
...
PY
    ...
    echo "Django project already exists; skipping scaffold."
  fi
'

# Bring up the full stack; entrypoint will migrate + run
docker compose up -d
